    ...
    <div className="min-h-screen pt-24 md:pt-28">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-16 md:py-24">
        ...
        <section className="mb-20 md:mb-24">
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-center mb-12 scroll-animate">Why You Should Attend</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            <div className="text-center hover-elevate p-6 rounded-lg transition-all scroll-animate stagger-1">
            ...
            <div className="text-center hover-elevate p-6 rounded-lg transition-all scroll-animate stagger-2">
              <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-foreground mb-4 transition-transform duration-300 hover:scale-110">
            ...
            <div className="text-center hover-elevate p-6 rounded-lg transition-all scroll-animate stagger-3">
              <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-foreground mb-4 transition-transform duration-300 hover:scale-110">
            ...
            <div className="text-center hover-elevate p-6 rounded-lg transition-all scroll-animate stagger-4">
              <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-foreground mb-4 transition-transform duration-300 hover:scale-110">
        ...
        <section className="mb-20 md:mb-24">
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-center mb-12 scroll-animate">Who Should Attend</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            <div className="bg-card rounded-lg p-6 hover-elevate transition-all scroll-animate stagger-1">
            ...
            <div className="bg-card rounded-lg p-6 hover-elevate transition-all scroll-animate stagger-2">
            ...
            <div className="bg-card rounded-lg p-6 hover-elevate transition-all scroll-animate stagger-3">
        ...
        <section className="mb-20 md:mb-24">
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-center mb-12 scroll-animate">Key Speaker Sessions</h2>
          <div className="space-y-6">
            ...
            <div className="bg-card rounded-lg p-6 hover-elevate transition-all scroll-animate stagger-4">
            ...
            <div className="bg-card rounded-lg p-6 hover-elevate transition-all scroll-animate stagger-5">
        ...
        <section className="mb-20 md:mb-24">
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-center mb-12 scroll-animate">Conference Highlights</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            <div className="text-center hover-elevate p-6 rounded-lg transition-all bg-card scroll-animate stagger-1">
              <Users className="text-primary mx-auto mb-3" size={32} />
              <h3 className="font-semibold text-lg mb-2">Panel Discussions</h3>
            </div>
            <div className="text-center hover-elevate p-6 rounded-lg transition-all bg-card scroll-animate stagger-2">
              <Trophy className="text-primary mx-auto mb-3" size={32} />
              <h3 className="font-semibold text-lg mb-2">Keynote Addresses</h3>
            </div>
            <div className="text-center hover-elevate p-6 rounded-lg transition-all bg-card scroll-animate stagger-3">
              <Lightbulb className="text-primary mx-auto mb-3" size={32} />
              <h3 className="font-semibold text-lg mb-2">Innovation Showcase</h3>
            </div>
            <div className="text-center hover-elevate p-6 rounded-lg transition-all bg-card scroll-animate stagger-4">
        ...
        <div className="relative h-56 md:h-72 rounded-2xl overflow-hidden mb-20 md:mb-24 scroll-animate">
          <img src={img3} alt="MEDFINTECH Conference" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-slate-900/30 to-transparent flex items-end p-8">
            <p className="text-white text-xl md:text-2xl font-bold max-w-xl">
              "The future of healthcare is digital. The future begins at MedFintech 2026."
            </p>
          </div>
        </div>
